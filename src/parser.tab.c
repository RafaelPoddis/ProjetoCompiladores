...
static const yytype_int8 yyrhs[] =
{
      ...
      48,    25,    43,     6,    43,    -1,     7,    24,    48,    25,
      43,    -1,     8,    22,    -1,     8,    48,    22,    -1,    49,
      21,    48,    -1,    50,    -1,     4,    -1,     4,    26,    48,
      27,    -1,    52,    51,    52,    -1,    52,    -1,    17,    -1,
...
#line 127 "parser.y"
    {
            ...
            (yyval.node)->varType = ((yyvsp[(1) - (3)].ival) == T_INT) ? Integer : Void;
            (yyval.node)->name = (yyvsp[(2) - (3)].sval); 
...
#line 134 "parser.y"
    {
            (yyval.node) = newStmtNode(VarDecK);
            (yyval.node)->varType = ((yyvsp[(1) - (6)].ival) == T_INT) ? Integer : Void;
            (yyval.node)->name = (yyvsp[(2) - (6)].sval);
            (yyval.node)->attr.val = (yyvsp[(4) - (6)].ival);
        ;}
    break;
...
#line 149 "parser.y"
    {
            ...
            (yyval.node)->varType = ((yyvsp[(1) - (6)].ival) == T_INT) ? Integer : Void;
            (yyval.node)->name = (yyvsp[(2) - (6)].sval);
            (yyval.node)->filho[0] = (yyvsp[(4) - (6)].node);
            (yyval.node)->filho[1] = (yyvsp[(6) - (6)].node);
        ;}
    break;
...
#line 180 "parser.y"
    {
            (yyval.node) = newStmtNode(VarDecK); 
            (yyval.node)->varType = ((yyvsp[(1) - (2)].ival) == T_INT) ? Integer : Void;
            (yyval.node)->name = (yyvsp[(2) - (2)].sval);
            (yyval.node)->attr.val = 0; 
        ;}
    break;
...
#line 187 "parser.y"
    {
            (yyval.node) = newStmtNode(VarDecK);
            (yyval.node)->varType = ((yyvsp[(1) - (4)].ival) == T_INT) ? Integer : Void;
            (yyval.node)->name = (yyvsp[(2) - (4)].sval);
...
#line 197 "parser.y"
    {
            ...
            (yyval.node)->filho[0] = (yyvsp[(2) - (4)].node); 
            (yyval.node)->filho[1] = (yyvsp[(3) - (4)].node); 
        ;}
    break;
...
#line 249 "parser.y"
    {
            ...
            (yyval.node)->filho[0] = (yyvsp[(3) - (5)].node); // condicao
            (yyval.node)->filho[1] = (yyvsp[(5) - (5)].node); // then
        ;}
    break;
...
#line 255 "parser.y"
    {
            (yyval.node) = newStmtNode(IfK);
            (yyval.node)->filho[0] = (yyvsp[(3) - (7)].node); // condicao
            (yyval.node)->filho[1] = (yyvsp[(5) - (7)].node); // then 
            (yyval.node)->filho[2] = (yyvsp[(7) - (7)].node); // else 
        ;}
    break;
...
#line 265 "parser.y"
    {
            ...
            (yyval.node)->filho[0] = (yyvsp[(3) - (5)].node); // condicao 
            (yyval.node)->filho[1] = (yyvsp[(5) - (5)].node); // loop 
        ;}
    break;
...
#line 278 "parser.y"
    {
            (yyval.node) = newStmtNode(ReturnK);
            (yyval.node)->filho[0] = (yyvsp[(2) - (3)].node);
        ;}
    break;
...
#line 286 "parser.y"
    {
            ...
            (yyval.node)->filho[0] = (yyvsp[(1) - (3)].node); //var
            (yyval.node)->filho[1] = (yyvsp[(3) - (3)].node); //Valor
        ;}
    break;
...
#line 296 "parser.y"
    {
            (yyval.node) = createIdNode((yyvsp[(1) - (1)].sval));
        ;}
    break;
...
#line 300 "parser.y"
    {
            (yyval.node) = createIdNode((yyvsp[(1) - (4)].sval));
            (yyval.node)->filho[0] = (yyvsp[(3) - (4)].node);
        ;}
    break;
...
#line 308 "parser.y"
    {
            switch((yyvsp[(2) - (3)].ival)) {
                case T_MENOR_IGUAL: (yyval.node) = createOpNode(LE_OP, (yyvsp[(1) - (3)].node), (yyvsp[(3) - (3)].node)); break;
                case T_MENOR:       (yyval.node) = createOpNode('<', (yyvsp[(1) - (3)].node), (yyvsp[(3) - (3)].node)); break;
                case T_MAIOR:       (yyval.node) = createOpNode('>', (yyvsp[(1) - (3)].node), (yyvsp[(3) - (3)].node)); break;
                case T_MAIOR_IGUAL: (yyval.node) = createOpNode(GE_OP, (yyvsp[(1) - (3)].node), (yyvsp[(3) - (3)].node)); break; 
                case T_IGUALDADE:   (yyval.node) = createOpNode(EQ_OP, (yyvsp[(1) - (3)].node), (yyvsp[(3) - (3)].node)); break;
                case T_DIFERENTE:   (yyval.node) = createOpNode(NE_OP, (yyvsp[(1) - (3)].node), (yyvsp[(3) - (3)].node)); break;
                default:            (yyval.node) = createOpNode('?', (yyvsp[(1) - (3)].node), (yyvsp[(3) - (3)].node));
            }
        ;}
    break;
...
#line 333 "parser.y"
    {
            (yyval.node) = ((yyvsp[(2) - (3)].ival) == T_MAIS) ? createOpNode('+', (yyvsp[(1) - (3)].node), (yyvsp[(3) - (3)].node)) : createOpNode('-', (yyvsp[(1) - (3)].node), (yyvsp[(3) - (3)].node));
        ;}
    break;
...
#line 346 "parser.y"
    {
            (yyval.node) = ((yyvsp[(2) - (3)].ival) == T_VEZES) ? createOpNode('*', (yyvsp[(1) - (3)].node), (yyvsp[(3) - (3)].node)) : createOpNode('/', (yyvsp[(1) - (3)].node), (yyvsp[(3) - (3)].node));
        ;}
    break;
...
/* Line 1455 of yacc.c  */
#line 361 "parser.y"
    { (yyval.node) = createValNode((yyvsp[(1) - (1)].ival)); ;}
    break;
...
#line 366 "parser.y"
    {
            ...
            (yyval.node)->name = (yyvsp[(1) - (4)].sval);
            (yyval.node)->filho[0] = (yyvsp[(3) - (4)].node); //args
        ;}
    break;
